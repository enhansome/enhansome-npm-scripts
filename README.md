...
* [npm-run-all2](https://github.com/bcomnes/npm-run-all2) ⭐ 440 | 🐛 5 | 🌐 JavaScript | 📅 2026-09-10 - Fully featured task runner.
...
* [opn-cli](https://github.com/sindresorhus/opn-cli) ⭐ 450 | 🐛 1 | 🌐 JavaScript | 📅 2026-03-25 - Open websites, files, executables, etc. with the user's preferred application.

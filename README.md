...
* [npm-run-all2](https://github.com/bcomnes/npm-run-all2) ⭐ 437 | 🐛 4 | 🌐 JavaScript | 📅 2026-08-05 - Fully featured task runner.
...
* [http-server](https://github.com/indexzero/http-server) ⭐ 14,232 | 🐛 108 | 🌐 JavaScript | 📅 2026-04-15 - Simple zero-configuration command-line http server.
